...
const pillars: Pillar[] = [
  ...
  {
    id: 'collaboration-and-community-impact',
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10">
            {pillars.map((pillar, idx) => (
              <motion.div
                ...
                className="group relative bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-xl transition-all duration-500 hover:-translate-y-1 cursor-pointer"
              ...
              >
                ...
                <div className="p-6 sm:p-8">
                  ...
                  {/* CTA */}
                  <button
                    className="inline-flex items-center gap-2.5 text-sm font-semibold transition-colors duration-300 group/link cursor-pointer"
                    style={{ color: pillar.accentColor }}
                    onClick={(e) => {
                      e.stopPropagation();
